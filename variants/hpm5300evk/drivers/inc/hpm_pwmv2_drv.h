...
static inline void pwmv2_trig_hardware_or_software_select_trigmux_index(PWMV2_Type *pwm_x, pwm_channel_t chn, uint8_t trigmux_index)
{
...
{
    return PWMV2_FORCE_WORK_VALUE_GET(pwm_x->FORCE_WORK);
}
...
{
    pwm_x->IRQ_STS &= PWMV2_IRQ_STS_IRQ_BURSTEND_MASK;
}

static inline void pwmv2_enable_calculate_overflow_irq(PWMV2_Type *pwm_x)
{
    pwm_x->IRQ_EN |= PWMV2_IRQ_EN_IRQ_EN_BURSTEND_MASK;
}
