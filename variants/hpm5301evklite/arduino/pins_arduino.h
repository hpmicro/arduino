...
#define PIN_PUSH_BUTTON_PRESSED HIGH
...
#define PIN_ADC       PIN_J3_26

/* Definiton for usb mouse sample */
#define PIN_USB_MOUSE_MOVE_UP       PIN_J3_27
#define PIN_USB_MOUSE_MOVE_DOWN     PIN_J3_28
#define PIN_USB_MOUSE_MOVE_LEFT     PIN_J3_7
#define PIN_USB_MOUSE_MOVE_RIGHT    PIN_J3_8
#define PIN_USB_MOUSE_BUTTON        PIN_J3_10
typedef enum {
    PIN_LED_BUILTIN = 0,
    PIN_LED_R = 0,
    PIN_LED_G = 1,
